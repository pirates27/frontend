...
@Component({
  ...
  template: `
    ...
    <nav class="bottom-nav">
      ...
      <a mat-button routerLink="/dashboard/buyer" [queryParams]="{ tab: 'saved' }" routerLinkActive="active">
      ...
      <a mat-button routerLink="/dashboard/buyer" [queryParams]="{ tab: 'visits' }" routerLinkActive="active">
