  ...
  template: `
    <div class="min-h-screen flex items-center justify-center bg-white px-4 relative overflow-hidden">
      ...
      <img 
        ...
        class="absolute bottom-0 left-0 w-40 sm:w-[32rem] object-contain pointer-events-none z-0"
        style="-webkit-mask-image: linear-gradient(to top right, black 60%, transparent 100%); mask-image: linear-gradient(to top right, black 60%, transparent 100%);"
      />
      ...
      <img 
        ...
        alt="Land scenery"
        class="absolute top-0 right-0 w-40 sm:w-[32rem] object-contain pointer-events-none z-0"
        style="-webkit-mask-image: linear-gradient(to bottom left, black 60%, transparent 100%); mask-image: linear-gradient(to bottom left, black 60%, transparent 100%);"
      />
